...
import com.mastercoding.thequizapp.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txtQuestion, 2);
        sViewsWithIds.put(R.id.radioGroup, 3);
        sViewsWithIds.put(R.id.radio1, 4);
        sViewsWithIds.put(R.id.radio2, 5);
        sViewsWithIds.put(R.id.radio3, 6);
        sViewsWithIds.put(R.id.radio4, 7);
        sViewsWithIds.put(R.id.btnNext, 8);
        sViewsWithIds.put(R.id.txtResult, 9);
    }
    // views
    @NonNull
